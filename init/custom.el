...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(powerline-active1 ((t (:inherit mode-line :background "#282828"))))
 '(powerline-active2 ((t (:inherit mode-line :background "#3C3C3C"))))
 '(powerline-inactive1 ((t (:inherit mode-line-inactive :background "#515151"))))
 '(powerline-inactive2 ((t (:inherit mode-line-inactive :background "#eeeeec")))))
